...
The code to support articulated cars is done. It's in beta because I wanted to add articulated diesel loco support as well, then got burnt out, then university started. So it's sidelined.
...
"pivots":
{
  [
    ...
    "modelIdentifier":   // put your model identifier here, leave blank / null for no model
    "truckIdentifier":   // same as above, if this is defined then this pivot will be treated as a truck
    "pivotA":            // name of the front pivot inside this list of pivots that the current pivot should base their position on. Leave blank / null if you have defined a truck
...
8. extra-long articulated sets allow switch to be set under them under certain conditions, leading to derailment / warping
   - [X] ~~Patched in beta12~~ Maybe probably finally possibly patched in beta13
